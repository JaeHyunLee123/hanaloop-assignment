...
* [Phase 5: Drizzle ORM 및 Supabase 연동 실제 API 마이그레이션](./05-drizzle-supabase-migration.md)
  * Supabase PostgreSQL 연동, Drizzle 스키마 설계 및 독립형 시드 스크립트 구축, 그리고 기존 페이크 API의 실제 DB 쿼리 및 트랜잭션 전환.
